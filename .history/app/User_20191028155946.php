...
class User extends Authenticatable
{
    ...
    /**
     * @SWG\Property(title="id",type="int")
     */
    public $id;

    /**
     * @SWG\Property(title="role_id",type="int")
     */
    public $role_id;

    /**
     * @SWG\Property(title="uid",type="int")
     */
    public $uid;

    /**
     * @SWG\Property(title="name",type="String")
     */
    public $name;

    /**
     * @SWG\Property(title="email",type="String")
     */
    public $email;
